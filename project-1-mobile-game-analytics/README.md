...
<a href="notebooks/final_project_variant_1.ipynb">
  <img src="../assets/project-previews/project-1-mobile-game-analytics.png" alt="Ключевые результаты проекта: retention и A/B-тест" width="100%">
</a>

**Быстрые ссылки:** [выполненный ноутбук](notebooks/final_project_variant_1.ipynb) · [отчёт для менеджера](reports/final_report.md) · [код retention](src/retention.py) · [тесты](tests/test_retention.py)
