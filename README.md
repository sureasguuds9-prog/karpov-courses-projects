...
Репозиторий объединяет учебные проекты по продуктовой аналитике, A/B-тестам, SQL, BI и прогнозированию метрик. В каждом оформленном проекте сохранены постановка задачи, данные, воспроизводимые расчёты, ограничения и бизнес-вывод.

## Материалы симулятора в одной папке

Отдельная подборка Airflow- и Telegram-отчётов, A/A- и A/B-тестов, анализа флешмоба, прогнозирования и SQL-аналитики доставки собрана в каталоге [simulator-projects](simulator-projects/). С него удобнее начинать, если нужны именно задания и код из симулятора Karpov.Courses.
